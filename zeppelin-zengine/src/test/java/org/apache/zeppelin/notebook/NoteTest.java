...
//    note.run(p.getId());
//
//    ArgumentCaptor<ParagraphJob> pCaptor = ArgumentCaptor.forClass(ParagraphJob.class);
...
//
//    assertEquals("ParagraphJob text", pText, pCaptor.getValue().getText());
//  }
//
//  @Test
...
//    ParagraphJob p1 = note.addNewParagraph(AuthenticationInfo.ANONYMOUS);
//    p1.setText("%spark ");
//    ParagraphJob p2 = note.insertNewParagraph(note.getParagraphs().size(), AuthenticationInfo.ANONYMOUS);
//
//    assertEquals("%spark\n", p2.getText());
//  }
//
...
//    Note note = new Note("test", "", interpreterFactory, interpreterSettingManager, paragraphJobListener, credentials, noteEventListener);
//    ParagraphJob p = note.insertNewParagraph(note.getParagraphs().size(), AuthenticationInfo.ANONYMOUS);
...
//    ParagraphJob baseParagraph = note.getParagraphs().get(0);
//    ParagraphJob user1Paragraph = baseParagraph.getUserParagraph(user1);
//    ParagraphJob user2Paragraph = baseParagraph.getUserParagraph(user2);
...
//
//    // test ParagraphJob Json
//    ParagraphJob p2 = ParagraphJob.fromJson(p.toJson());
