...
public class PostgreSqlInterpreterTest extends BasicJDBCTestCaseAdapter {
  ...
  public void testAutoCompletion() throws SQLException {
    ...
    InterpreterCompletion selectCompletion = new InterpreterCompletion("SELECT ", "SELECT ", null);
    assertEquals(selectCompletion, psqlInterpreter.completion("SEL", 0, null).iterator().next());
