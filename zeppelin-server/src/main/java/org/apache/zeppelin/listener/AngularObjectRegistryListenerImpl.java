...
//      }
//
//      final List<InterpreterSetting> intpSettings = interpreterSettingRepository.getInterpreterSettings(note.getId());
...
//      }
//
//      final List<String> settingIds = interpreterSettingRepository.getSettingIds();
