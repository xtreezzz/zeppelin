...
public class RegisterInfo implements org.apache.thrift.TBase<RegisterInfo, RegisterInfo._Fields>, java.io.Serializable, Cloneable, Comparable<RegisterInfo> {
  ...
  private static final org.apache.thrift.protocol.TField INTERPRETER_GROUP_FIELD_DESC = new org.apache.thrift.protocol.TField("interpreterGroup", org.apache.thrift.protocol.TType.STRING, (short)3);
  ...
  public java.lang.String interpreterGroup; // required

  /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    HOST((short)1, "host"),
    PORT((short)2, "port"),
    INTERPRETER_GROUP((short)3, "interpreterGroup");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 2: // PORT
          return PORT;
        case 3: // INTERPRETER_GROUP
          return INTERPRETER_GROUP;
        default:
          return null;
      }
    }
  ...
  static {
    ...
    tmpMap.put(_Fields.INTERPRETER_GROUP, new org.apache.thrift.meta_data.FieldMetaData("interpreterGroup", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
  ...
  public RegisterInfo(
    ...
    int port,
    java.lang.String interpreterGroup)
  {
    this();
    this.host = host;
    this.port = port;
  ...
  public RegisterInfo(RegisterInfo other) {
    ...
    if (other.isSetInterpreterGroup()) {
      this.interpreterGroup = other.interpreterGroup;
    }
  }
  ...
  public java.lang.String getInterpreterGroup() {
    return this.interpreterGroup;
  }

  public RegisterInfo setInterpreterGroup(java.lang.String interpreterGroup) {
    this.interpreterGroup = interpreterGroup;
    return this;
  }

  public void unsetInterpreterGroup() {
    this.interpreterGroup = null;
  }

  /** Returns true if field interpreterGroup is set (has been assigned a value) and false otherwise */
  public boolean isSetInterpreterGroup() {
    return this.interpreterGroup != null;
  }

  public void setInterpreterGroupIsSet(boolean value) {
    if (!value) {
      this.interpreterGroup = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case INTERPRETER_GROUP:
      if (value == null) {
        unsetInterpreterGroup();
      } else {
        setInterpreterGroup((java.lang.String)value);
      }
      break;
  ...
  public boolean equals(RegisterInfo that) {
    ...
    boolean this_present_interpreterGroup = true && this.isSetInterpreterGroup();
    boolean that_present_interpreterGroup = true && that.isSetInterpreterGroup();
    if (this_present_interpreterGroup || that_present_interpreterGroup) {
      if (!(this_present_interpreterGroup && that_present_interpreterGroup))
        return false;
      if (!this.interpreterGroup.equals(that.interpreterGroup))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetInterpreterGroup()) ? 131071 : 524287);
    if (isSetInterpreterGroup())
      hashCode = hashCode * 8191 + interpreterGroup.hashCode();
  ...
  public int compareTo(RegisterInfo other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetInterpreterGroup()).compareTo(other.isSetInterpreterGroup());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetInterpreterGroup()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.interpreterGroup, other.interpreterGroup);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    first = false;
    if (!first) sb.append(", ");
    sb.append("interpreterGroup:");
    if (this.interpreterGroup == null) {
      sb.append("null");
    } else {
      sb.append(this.interpreterGroup);
    }
    first = false;
    sb.append(")");
    return sb.toString();
  ...
  private static class RegisterInfoStandardScheme extends org.apache.thrift.scheme.StandardScheme<RegisterInfo> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, RegisterInfo struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 3: // INTERPRETER_GROUP
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.interpreterGroup = iprot.readString();
              struct.setInterpreterGroupIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RegisterInfo struct) throws org.apache.thrift.TException {
      ...
      oprot.writeFieldEnd();
      if (struct.interpreterGroup != null) {
        oprot.writeFieldBegin(INTERPRETER_GROUP_FIELD_DESC);
        oprot.writeString(struct.interpreterGroup);
        oprot.writeFieldEnd();
      }
  ...
  private static class RegisterInfoTupleScheme extends org.apache.thrift.scheme.TupleScheme<RegisterInfo> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, RegisterInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetInterpreterGroup()) {
        optionals.set(2);
      }
